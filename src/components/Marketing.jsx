...
const Marketing = () => {
  return (
    <div id="Marketing" className="w-screen overflow-hidden">
      <div className="bg-black text-white py-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-12 sm:px-12 md:px-12 lg:px-20">
          ...
          {/*desktop */}
          <motion.div
            className="hidden sm:flex md:flex flex-col justify-center space-y-4 lg:col-span-2"
            variants={textVariants}
            initial="hidden"
            whileInView="visible"
          ...
          >
            <h2 className="text-4xl font-bold leading-snug mt-2">
              Our <span className="text-green-500">Digital <br /> Marketing</span> Expertise
            </h2>
